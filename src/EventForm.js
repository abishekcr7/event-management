...
const EventForm = (props) => {
  ...
  return (
    <>
      {!edit && (
        <div className="rounded-lg ... w-96 p-5 bg-purple-600 border border-indigo-600 ... flex justify-center">
          <button
      ...
      {edit && (
        <div className="rounded-lg ... w-96 p-5 bg-purple-600 border border-indigo-600 ...">
